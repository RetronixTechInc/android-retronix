...
public final class RotationPolicy {
    ...
    public static void setRotationLockAtAngle(Context context, final boolean enabled,
        ...
        int rot = Settings.System.getIntForUser(context.getContentResolver(), Settings.System.USER_ROTATION, -1, UserHandle.USER_CURRENT);
		Log.w(TAG, "USER_ROTATION = " + rot);
		
		if(rot >= 0 && rot <= 3)
		{
        	setRotationLock(enabled, rot);
		}
