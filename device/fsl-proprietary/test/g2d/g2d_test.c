...
/****************************************** test g2d_blit *********************************************************/
   ...
   /******************************test alpha blending with Porter-Duff modes ***************************************/
    ...
    dst.blendfunc = G2D_ONE_MINUS_SRC_ALPHA | G2D_PRE_MULTIPLIED_ALPHA | G2D_DEMULTIPLY_OUT_ALPHA;
