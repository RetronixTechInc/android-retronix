...
PRODUCT_COPY_FILES +=	\
    ...
    device/fsl/imx6sx/etc/init.usb.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/hw/init.freescale.usb.rc \
    device/fsl/imx6sx/etc/ota.conf:$(TARGET_COPY_OUT_VENDOR)/etc/ota.conf \
