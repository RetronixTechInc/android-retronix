...
PRODUCT_COPY_FILES += \
	...
	device/rtx/a6plus_imx6dq/etc/apns-conf.xml:system/etc/apns-conf.xml \
	device/rtx/a6plus_imx6dq/etc/init.usb.rc:root/init.retronix.usb.rc \
	device/rtx/a6plus_imx6dq/etc/ueventd.retronix.rc:root/ueventd.retronix.rc \
	device/rtx/a6plus_imx6dq/etc/ppp/init.gprs-pppd:system/etc/ppp/init.gprs-pppd \
	device/rtx/a6plus_imx6dq/etc/ota.conf:system/etc/ota.conf \
    device/rtx/a6plus_imx6dq/etc/init.recovery.retronix.rc:root/init.recovery.retronix.rc \
...
ifneq ($(wildcard device/rtx/a6plus_imx6dq/etc/fstab.emmc.retronix),)
$(shell touch device/rtx/a6plus_imx6dq/etc/fstab.emmc.retronix)
endif

ifneq ($(wildcard device/rtx/a6plus_imx6dq/etc/fstab.sd.retronix),)
$(shell touch device/rtx/a6plus_imx6dq/etc/fstab.sd.retronix)
endif

# Overrides
PRODUCT_NAME := a6plus_imx6dq
PRODUCT_DEVICE := a6plus_imx6dq

PRODUCT_COPY_FILES += \
	device/rtx/a6plus_imx6dq/etc/init.rc:root/init.retronix.rc \
	device/rtx/a6plus_imx6dq/etc/audio_policy.conf:system/etc/audio_policy.conf \
	device/rtx/a6plus_imx6dq/etc/audio_effects.conf:system/vendor/etc/audio_effects.conf
...
DEVICE_PACKAGE_OVERLAYS := device/rtx/a6plus_imx6dq/overlay
...
PRODUCT_COPY_FILES += \
	...
	device/rtx/a6plus_imx6dq/required_hardware.xml:system/etc/permissions/required_hardware.xml
PRODUCT_PACKAGES += \
					AudioRoute			\
					RTX_Tools
