...
TARGET_RECOVERY_FSTAB = device/rtx/pitx_imx6dq/etc/fstab.sd.retronix

# build for ext4
PRODUCT_COPY_FILES +=	\
	device/rtx/pitx_imx6dq/etc/fstab.sd.retronix:root/fstab.retronix
...
TARGET_RECOVERY_FSTAB = device/rtx/pitx_imx6dq/etc/fstab.emmc.retronix

# build for ext4
PRODUCT_COPY_FILES +=	\
	device/rtx/pitx_imx6dq/etc/fstab.emmc.retronix:root/fstab.retronix
...
UBI_ROOT_INI := device/rtx/pitx_imx6dq/ubi/ubinize.ini
...
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/rtx/pitx_imx6dq/bluetooth
...
BOARD_SEPOLICY_DIRS := \
       device/rtx/pitx_imx6dq/sepolicy 
