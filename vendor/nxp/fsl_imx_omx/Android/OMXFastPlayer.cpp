...
int OMXFastPlayer::getAudioTrackCount()
{

    return 2;
}

char* OMXFastPlayer::getAudioTrackName(int index)
{
    char name[32];
...
int OMXFastPlayer::getCurrentAudioTrackIndex()
{
    return 1;
}

status_t OMXFastPlayer::selectAudioTrack(int index)
{
