...
{
    fsl_osal_memset(&_mDisp, 0, sizeof(_mDisp));
    _mSrc_width = _mSrc_height = _mSrc_mheight = _mSrc_pitch = 0;
    _mSrc_crop_left = _mSrc_crop_top = _mSrc_crop_width = _mSrc_crop_height = 0;
    _mDst_width = _mDst_height = _mDst_pitch = 0;
    _mRotation = 0;
    _mIsZoom = _mIsFlip = false;
    _mColorFormat = OMX_COLOR_FormatUnused;
}
