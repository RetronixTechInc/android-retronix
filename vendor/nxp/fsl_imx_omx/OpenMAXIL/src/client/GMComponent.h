...
typedef OMX_ERRORTYPE (*EMPTYDONECALLBACKTYPE)(GMComponent *pComponent, OMX_PTR pAppData, OMX_BUFFERHEADERTYPE *pBufferHdr);
...
class GMComponent {
    public:
        ...
        OMX_BOOL IsSoftwareBasedVideoDecoder();
        ...
        OMX_ERRORTYPE RegistEmptyDoneCallback(EMPTYDONECALLBACKTYPE emptyDoneCb, OMX_PTR pAppData);
        ...
        OMX_ERRORTYPE LoadWithComponentHandle(OMX_HANDLETYPE handle, OMX_STRING role);
        OMX_ERRORTYPE GetBufferHdrOnPort(OMX_U32 nPortIndex, OMX_U32 index, OMX_BUFFERHEADERTYPE **ppBufferHdr);
    private:
        ...
        OMX_PTR EmptyDoneCbAppData;
        OMX_PTR pBufAppData;
        OMX_BOOL bResetTimeout;
        OMX_BOOL bIsSoftwareVideoDecoder;
        fsl_osal_ptr Cond;
        ...
        OMX_ERRORTYPE SetGeneralSetting();
};
